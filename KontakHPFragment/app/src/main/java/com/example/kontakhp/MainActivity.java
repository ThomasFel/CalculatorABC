...
public class MainActivity extends AppCompatActivity {
    private ListView lv;
    private ImageView add, edit, find, del, change;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        change.setOnClickListener(operasi);
    ...
    View.OnClickListener operasi = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.change:change_fragment();
                break;
            }
        }
    };
    ...
    private void change_fragment() {
        Intent intentku = new Intent(getBaseContext(), FragmentActivity.class);
